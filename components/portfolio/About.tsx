...
export default function About() {
  ...
  return (
    <section id="about" className="py-24 px-4 sm:px-6 lg:px-8 relative bg-muted/30">
      ...
      <div className="absolute bottom-0 left-0 w-1/3 h-1/3 bg-accent/5 rounded-full blur-[100px] pointer-events-none"></div>

      <div className="max-w-6xl mx-auto relative z-10">
        <div className="text-center mb-20">
          <h2 className="text-3xl sm:text-5xl font-bold mb-6">
            <span className="bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent">À Propos de Moi</span>
          </h2>
          <div className="w-24 h-1.5 bg-gradient-to-r from-primary via-purple-500 to-accent mx-auto rounded-full"></div>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-16 items-center mb-24">
          <div className="space-y-8 animate-in slide-in-from-left duration-700 delay-200">
            <p className="text-lg text-muted-foreground leading-relaxed">
              ...
              dans la création de <span className="font-semibold text-primary">solutions web et mobiles</span> innovantes
              et performantes.
            </p>
            <p className="text-lg text-muted-foreground leading-relaxed">
              En tant que <span className="font-semibold text-primary">développeur fullstack</span>, je maîtrise
              l'ensemble du cycle de développement, de la conception à la mise en production.
              Mon expertise s'étend également à la <span className="font-semibold text-primary">maintenance informatique</span> et
              au <span className="font-semibold text-primary">design</span>.
            </p>
            <p className="text-lg text-muted-foreground leading-relaxed">
          ...
          <div className="relative animate-in slide-in-from-right duration-700 delay-400">
            <div className="absolute inset-0 bg-gradient-to-br from-primary via-purple-500 to-accent rounded-3xl transform rotate-3 opacity-20 blur-lg"></div>
              ...
              <ul className="space-y-6">
                {[
                  ...
                  <li key={i} className="flex items-start gap-4 group">
                    <div className="w-2 h-2 bg-primary rounded-full mt-2.5 group-hover:scale-150 transition-transform duration-300"></div>
